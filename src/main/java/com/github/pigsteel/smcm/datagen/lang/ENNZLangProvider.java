...
public class ENNZLangProvider extends LanguageProvider implements SMCMLangProviderVariables {
    public ENNZLangProvider(PackOutput output) {
        super(output, SMCM.MOD_ID, "en_nz");
    }
