...
public class ENCALangProvider extends LanguageProvider implements SMCMLangProviderVariables {

    public ENCALangProvider(PackOutput output) {
        super(output, SMCM.MOD_ID, "en_ca");
    }
