...
public class ENPTLangProvider extends LanguageProvider implements SMCMLangProviderVariables {
    ...
    protected void addTranslations() {
        ...
        add("subtitles.smcm.entity.parrot.imitate.frostbitten", ParrotImitates() + " moanin'");
        add("subtitles.smcm.entity.parrot.imitate.reclaimed", ParrotImitates() + " groanin'");
        add("subtitles.smcm.entity.parrot.imitate.enchanter", ParrotImitates() + " burblin'");
    }
    ...
    public String FrozenZombieName() {
        return "Frozen sailor";
    }

    @Override
    public String JungleZombieName() {
        return "Landlocked sailor";
    }
