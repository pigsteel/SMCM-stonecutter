package com.github.pigsteel.smcm.entity.monster.necromancer;
...
public class Necromancer extends Monster {
    ...
    protected static final EntityDataAccessor<smcm$Pose> DATA_POSE = SynchedEntityData.defineId(Necromancer.class, smcm$EntityDataSerializers.EXTENDED_POSES);
    ...
    protected void defineSynchedData(SynchedEntityData.Builder builder) {
        ...
        //builder.define(DATA_POSE, smcm$Pose.fromPose(this.getPose()));
    }
    ...
    /*public smcm$Pose getExtendedPose() {
        return this.entityData.get(DATA_POSE);
    }*/

    /*public void setPose(smcm$Pose pose) {
    ...
    public void setPose(Pose pose) {
        super.setPose(pose);
        this.entityData.set(DATA_POSE, smcm$Pose.fromPose(pose));
    }
